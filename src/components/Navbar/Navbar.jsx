...
export const Navbar = () => {
  ...
  const [cartItems] = useState(3) // عدد عناصر السلة التجريبي
          ...
          <div className={`md:hidden overflow-hidden transition-all duration-300 ${isMenuOpen ? 'max-h-96' : 'max-h-0'}`}>
            <div className="pb-4 space-y-4">
              <div className="relative">
                <input
                    type="text"
                    placeholder="ابحث في علي إكسبريس..."
              ...
              <div className="flex flex-col space-y-2 pl-2">
                ...
                <div className="flex items-center gap-2 py-2">
                  ...
                  <span className="text-gray-700">السلة ({cartItems})</span>
                </div>
              </div>
            </div>
          </div>
